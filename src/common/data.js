...
export const albumList = [
  { title: '一起坐在海边吹海风', url: getURL('album', '1.webp') },
	{ title: '小兔子滴妈妈', url: getURL('album', '2.webp') },
	{ title: '小兔子滴爸爸', url: getURL('album', '3.webp') },
	{ title: '抱抱~', url: getURL('album', '4.webp') },
	{ title: '在晴天的海边，一起爱的魔力转圈圈~', url: getURL('album', '5.webp') },
	{ title: '亲亲~', url: getURL('album', '6.webp') },
	{ title: '光着脚丫感受大海', url: getURL('album', '7.webp') },
	{ title: '两蜘蛛', url: getURL('album', '8.webp') },
	{ title: '两个憨憨的迷惑行为', url: getURL('album', '9.webp') },
	{ title: '阿西里西~阿西里西~', url: getURL('album', '10.webp') },
	{ title: '赶地铁呀呀呀', url: getURL('album', '11.webp') },
	{ title: '坐公交呀呀呀', url: getURL('album', '12.webp') },
	{ title: '生气了，哄不好了。', url: getURL('album', '13.webp') },
	{ title: '网友奔现啦~', url: getURL('album', '14.webp') },
	{ title: '表面上：吹海风。实际上：在风中凌乱~', url: getURL('album', '15.webp') },
	{ title: '这谁家修狗长得真别致', url: getURL('album', '16.webp') },
	{ title: '剪刀脚', url: getURL('album', '17.webp') },
	{ title: '卡姿兰大眼睛~', url: getURL('album', '18.webp') },
	{ title: '好兄弟就要一辈子！', url: getURL('album', '19.webp') },
	{ title: '来看五月天啦！', url: getURL('album', '20.webp') },
]